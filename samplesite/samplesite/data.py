...
def mainfunc(request):
    ...
    url0 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + dt.strftime(
        '%Y/%m/%d') + '&starts_at_max=' + d1.strftime('%Y/%m/%d')
    url1 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + d1.strftime(
        '%Y/%m/%d') + '&starts_at_max=' + d2.strftime('%Y/%m/%d')
    url2 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + d2.strftime(
        '%Y/%m/%d') + '&starts_at_max=' + d3.strftime('%Y/%m/%d')
    url3 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + d3.strftime(
        '%Y/%m/%d') + '&starts_at_max=' + d4.strftime('%Y/%m/%d')
    url4 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + d4.strftime(
        '%Y/%m/%d') + '&starts_at_max=' + d5.strftime('%Y/%m/%d')
    url5 = 'https://api.timepad.ru/v1/events.json?limit=20&skip=0&cities=Москва' + ids + '&fields=organization&sort=+starts_at&price_max=0' + '&starts_at_min=' + d5.strftime(
